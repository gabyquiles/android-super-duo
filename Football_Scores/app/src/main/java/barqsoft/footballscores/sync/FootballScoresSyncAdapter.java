...
public class FootballScoresSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private static final int INDEX_MATCH_DAY = 0;
    private static final int INDEX_HOME_TEAM = 0;
    private static final int INDEX_AWAY_TEAM = 0;
    private static final int INDEX_HOME_GOALS = 0;
    private static final int INDEX_AWAY_GOALS = 0;
